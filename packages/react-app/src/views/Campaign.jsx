                                        ...
                                        */}
                                        ...
                                        <section className="finances">
                                                ...
                                                <section className="income-generating-assets">
                                                  <Element name="assets" className="element">
                                                ...
                                                <section className="income-distributions">
                                                  <Element name="income-distributions" className="element">
                                                ...
                                                <section className="associated-wallet-addresses">
                                                  <Element name="wallet-addresses" className="element">
